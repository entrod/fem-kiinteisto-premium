      ...
      <div className="container-narrow">
        <FadeIn>
          <p className="text-primary font-medium text-sm tracking-widest uppercase mb-6">
            Kiinteistöpalvelut — Jakobstad
          </p>
        </FadeIn>
        <FadeIn delay={100}>
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight max-w-4xl mb-8">
            Modern kiinteistöpalvelu
            <br />
            <span className="text-gradient">för taloyhtiöt</span> i Jakobstad
          </h1>
        </FadeIn>
        <FadeIn delay={200}>
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
            Snabbare service. Tydligare kommunikation. Enklare vardag.
          </p>
        </FadeIn>
        <FadeIn delay={300}>
