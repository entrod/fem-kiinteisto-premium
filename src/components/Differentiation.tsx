  ...
  return (
    <section className="section-padding">
      <div className="container-narrow">
        <FadeIn>
          <p className="text-primary text-sm font-medium tracking-widest uppercase mb-4">Skillnaden</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <FadeIn delay={100}>
            <div className="border border-border rounded-3xl p-8 bg-secondary/30">
              <h3 className="font-display text-lg font-semibold text-muted-foreground mb-6">Traditionellt</h3>
